...
public class WriteOneFilePerWindow extends PTransform<PCollection<String>, PDone> {
    ...
    public WriteOneFilePerWindow(String filenamePrefix, String filenameSuffix, Integer numShards) {
    ...
    public PDone expand(PCollection<String> input) {
        ...
        TextIO.Write write =
                TextIO.write()
                        .to(new PerWindowFiles(resource, filenameSuffix))
    ...
    public static class PerWindowFiles extends FilenamePolicy {
        ...
        public PerWindowFiles(ResourceId baseFilename, String filenameSuffix) {
